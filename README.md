...
* [CodePen with a sample weather widget in jquery](http://codepen.io/anon/pen/YwJLJE) - uses json weather data from [openweathermap.org]{http://openweathermap.org/current}
